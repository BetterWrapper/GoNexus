...
// Constants
const { FLICKR_API_URL, DEFAULT_PARAMS, FLICKR_CONSUMER_KEY, FLICKR_CONSUMER_SECRET } = require('./constants');
 ...
 * Test login
 ***/
exports.testLogin = async (connectionData) => {
  return await flickr
    .get()
    .qs({
 ...
 * Get list of methods
 ***/
exports.getMethods = async (connectionData) => {
  return await flickr
    .get()
    .qs({
 ...
 * Get method info
 ***/
exports.getMethodInfo = async (connectionData, methodName) => {
  return await flickr
    .get()
    .qs({
 ...
 * Generic call
 ***/
exports.doCall = (connectionData, method) => {
  return (req, res) => {
    flickr
      .get()
      .qs({
